const UserGuide = () => {
  ...
  return (
    <div className='user-guide flex justify-center items-center flex-col'>
      <h1>User Guide: Safe HTML and CSS Practices</h1>
      ...
      <section style={sectionStyle}>
        <h2 className='text-center font-bold'>Conclusion</h2>
        <p style={pStyle}>
        ...
        <p style={pStyle}>
          ...
          refer to our comprehensive documentation or contact our support team.
        </p>
      </section>
    </div>
  );
