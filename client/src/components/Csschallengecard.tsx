    ...
    <>
      <div>
        {/* <Link
          to={`${id}`}
          key={id}
          className='text-inherit no-underline `m-4 card  h-[50vh] w-[78vw] card border relative overflow-hidden cursor-pointer flex  justify-between  '
          {...hoverProps}
        > */}
        <div className='flex justify-center h-auto w-auto md:flex-row flex-col-reverse overflow-hidden cursor-pointer card border '>
          {/* <Link
            to={`${id}`}
            key={id}
            className='text-inherit no-underline `m-4 card  md:h-[50vh] md:w-[78vw] card border relative overflow-hidden cursor-pointer flex  justify-between h-auto w-auto md:flex-row flex-col-reverse '
            {...hoverProps}
          > */}
          <div
            className={`ml-[2.5rem] flex overflow-hidden flex-col md:justify-evenly align-center card_desc relative md:min-w-[30%] md:max-w-[40%] w-auto justify-center items-center m-[2.5rem] gap-[2rem]`}
          >
            <p
            ...
            <div className='flex justify-start'>
              ...
              <span className='ml-3'>{numSubmissions}</span>
            </div>
          </div>
